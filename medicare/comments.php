...
<div id="comments" class="btCommentsBox">
	...
	<?php 
		...
		$args = array(
		  ...
		  'submit_button' => '<button type="submit" value="' . esc_html__( 'Post Comment', 'medicare' ) . '" id="btSubmit" class="btBtn btBtn btnFilledStyle btnAccentColor btnMedium btnNormalWidth btnRightPosition btnIco" name="submit" data-ico-fa="&#xf1d8;">' . esc_html__( 'Post Comment', 'medicare' ) . '</button>',
